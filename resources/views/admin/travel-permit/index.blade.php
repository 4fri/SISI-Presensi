                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Travel Permit</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 text-end">
                            @role('employee')
                                <a class="btn btn-primary btn-sm" href="{{ route('create_travel_permit') }}">Add</a>
                            @endrole
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Travel Permit</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-responsive-xl">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Position</th>
                                            <th>ID NUMBER</th>
                                            <th>Date Travel Permit</th>
                                            <th>Description</th>
                                            <th class="text-center">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($travelPermits as $value)
                                            @php
                                                $count = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('update_travel_permit', $value->id) }}"
                        ...
                        <div class="container">
                            <div class="pagination d-flex">
                                <small>{{ $travelPermits->links() }}</small>
                            </div>
                        </div>
                        <!-- /.card -->
                    </div>
