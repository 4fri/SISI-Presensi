                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('store_position') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="positionName">Position Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{ old('name') }}" id="positionName"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('salary') is-invalid @enderror"
                                            name="salary" value="{{ old('salary') }}" id="salary">
                                        @error('salary')
                                            <div class="invalid-feedback">
                                                <strong><small>{{ $message }}</small></strong>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="salary_note" value="{{ old('salary_note') }}" id="salaryNote"
                                            placeholder="Example: Daily, Weekly">
                                        @error('salary_note')
                                            <div class="invalid-feedback">
                                                <strong><small>{{ $message }}</small></strong>
                                            </div>
